...
// API Key SetUp
const API_KEY = "AIzaSyCUHnfV6zq7uLKC2AtoRUZ2a4PLaF1Lf70";
const API_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent?key=${API_KEY}`;

//"new gemini" model - DOESNT WORK
//const API_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-2.0-pro:generateContent?key=${API_KEY}`;
...
const generateBotResponse = async (incomingMessageDiv) => {
  ...
  const data = await response.json();
    ...
    //Reset User filedata, remove thinking indicator and scroll chat to bottom
    userData.file = {};
...
//Handle fule input change and preview the selected file
...
//Initialize Emoji picker and handle emojis selection
